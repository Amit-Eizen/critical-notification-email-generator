...
function generateReportOpeningHTML(reportName, reportDate) {
    ...
    <img src="../images/Ongoing Critical.png" style="width: 100%; max-width: 900px; display: block; margin-bottom: 20px;" alt="Critical Notification">
...
function generateReportResolvedHTML(reportName, reportDate) {
    return `<div style="font-family: Calibri, Arial, sans-serif; font-size: 11pt;">
    <img src="../images/Resolved Critical.png" style="width: 100%; max-width: 900px; display: block; margin-bottom: 20px;" alt="Critical Notification - Resolved">
